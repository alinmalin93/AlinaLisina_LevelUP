...
public class DraftPage {
    ...
    public static final By DRAFT_THEME = By.cssSelector(".mail-MessageSnippet-Item_body>div>span>span>span:nth-child(1)>span");
    public static final By DRAFT_BODY = By.xpath(".mail-MessageSnippet-Item_body>div>span>span:nth-child(2)>span");
